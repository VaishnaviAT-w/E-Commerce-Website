...
using static E_Commerce_Website.Data.Enum.EnumResponse;
    ...
    namespace E_Commerce_Website.BI.Service
    {
        public class UserService : IUserService
        {
            ...
            public async Task<UserListResponseDto> GetAllUsers(string? name = null, string? email = null, bool? isActive = null)
            {
    ...
    .WhereIf(!string.IsNullOrEmpty(name), u => u.Fullname.Contains(name))
    ...
    .ToList();
                ...
                response.Users = users.Select(UserMapper.MaptoDto).ToList();
